    ...
    <Section className="destinationsection">
      <Container>
        ...
        <div className="tooltiptext">
            ...
            <div className="spacer"> <p><br />Elephant poaching tools include <strong><span className="texthl">helicopters, military grade weaponry, and poisoned pumpkins</span></strong></p></div>
            {/* <br />
